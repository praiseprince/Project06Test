...
app.register_blueprint(api_bp)     # Register the blueprint with the main app
...
def create_checkout_session():
    try:
        # Simulating a Stripe-like session object
        session = {
            'client_reference_id': current_user.id
        }
        
        # Directly fulfilling the order
        fulfill_order(session)

        return redirect(url_for('home'))  # Redirect to success page
